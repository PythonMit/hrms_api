...
namespace HRMS.DBL.Migrations
{
    ...
    [Migration("20230222071540_Alter_EmployeeOverTime_EmployeeLeaveApplicationEntity_Table")]
    partial class AlterEmployeeOverTimeEmployeeLeaveApplicationEntityTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HRMS.DBL.Entities.EmployeeLeaveApplication", b =>
                {
                    ...
                    b.Property<int?>("FirstProjectManagerId")
                        .HasColumnType("int")
                        .HasColumnName("FirstProjectManagerId");
                    ...
                    b.Property<int?>("SecondProjectManagerId")
                        .HasColumnType("int")
                        .HasColumnName("SecondProjectManagerId");
                    ...
                    b.HasIndex("FirstProjectManagerId");

                    b.HasIndex("ImagekitDetailFileId");

                    b.HasIndex("LeaveTypeId");

                    b.HasIndex("SecondProjectManagerId");
            ...
            modelBuilder.Entity("HRMS.DBL.Entities.EmployeeLeaveApplication", b =>
                {
                    ...
                    b.HasOne("HRMS.DBL.Entities.Employee", "FirstProjectManager")
                        .WithMany()
                        .HasForeignKey("FirstProjectManagerId");
                    ...
                    b.HasOne("HRMS.DBL.Entities.Employee", "SecondProjectManager")
                        .WithMany()
                        .HasForeignKey("SecondProjectManagerId");

                    b.Navigation("EmployeeContract");

                    b.Navigation("EmployeeLeaveStatus");

                    b.Navigation("FirstProjectManager");

                    b.Navigation("ImagekitDetail");

                    b.Navigation("LeaveType");

                    b.Navigation("SecondProjectManager");
                });
