...
namespace HRMS.DBL.Migrations
{
    ...
    [Migration("20240229093401_Update_ResourceUserHistory_AddEmployee_LogBy_Relationship")]
    partial class UpdateResourceUserHistoryAddEmployeeLogByRelationship
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HRMS.DBL.Entities.EmployeeBankDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("BeneficiaryACNumber")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("HRMS.DBL.Entities.EmployeeHoldSalary", b =>
                {
                    ...
                    b.Property<int>("EmployeeSalaryStatusId")
                        .HasColumnType("int")
                        .HasColumnName("EmployeeSalaryStatusId");
                    ...
                    b.HasIndex("EmployeeSalaryStatusId");
            ...
            modelBuilder.Entity("HRMS.DBL.Entities.Resource", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("PhysicalLocation")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("PhysicalLocation");
            ...
            modelBuilder.Entity("HRMS.DBL.Entities.ResourceType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HRMS.DBL.Entities.ResourceUserHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ResourceUserHistory", (string)null);
                });
            ...
            modelBuilder.Entity("HRMS.DBL.Entities.EmployeeDetail", b =>
                {
                    b.HasOne("HRMS.DBL.Entities.EmployeeBankDetail", "EmployeeBankDetail")
                        .WithMany()
            ...
            modelBuilder.Entity("HRMS.DBL.Entities.EmployeeHoldSalary", b =>
                {
                    b.HasOne("HRMS.DBL.Entities.EmployeeEarningGross", "EmployeeEarningGross")
                        .WithMany("EmployeeHoldSalaries")
                        .HasForeignKey("EmployeeEarningGrossId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HRMS.DBL.Entities.EmployeeSalaryStatus", "EmployeeSalaryStatus")
                        .WithMany()
                        .HasForeignKey("EmployeeSalaryStatusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("EmployeeEarningGross");

                    b.Navigation("EmployeeSalaryStatus");
                });
            ...
            modelBuilder.Entity("HRMS.DBL.Entities.Resource", b =>
                {
                    ...
                    b.HasOne("HRMS.DBL.Entities.ResourceType", "ResourceType")
                        .WithMany()
            ...
            modelBuilder.Entity("HRMS.DBL.Entities.ResourceUserHistory", b =>
                {
                    ...
                    b.HasOne("HRMS.DBL.Entities.Resource", "Resource")
                        .WithMany()
            ...
            modelBuilder.Entity("HRMS.DBL.Entities.EmployeeEarningGross", b =>
                {
                    b.Navigation("EmployeeHoldSalaries");
                });
